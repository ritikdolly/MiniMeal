        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between animate-slideDown">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button
              ...
              className="text-gray-700 font-medium hover:text-orange-600 transition cursor-pointer"
            >
              Login
            </button>
        ...
        >
          <nav className="flex flex-col px-6 pb-4 space-y-4">
            ...
            <button
              ...
              className="border border-orange-500 text-orange-500 py-2 rounded-full
            ...
            <button
              ...
              className="bg-orange-500 text-white py-2 rounded-full
